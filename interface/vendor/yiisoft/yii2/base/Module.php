...
class Module extends ServiceLocator
{
     ...
     * For example, `help`, `post/create`, `electronic/post/create`.
     ...
     * @param string $id module ID. For grand child modules, use ID path relative to this module (e.g. `electronic/content`).
     ...
     * use ID path relative to this module (e.g. `electronic/content`).
