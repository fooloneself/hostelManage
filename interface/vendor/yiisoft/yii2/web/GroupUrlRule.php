 ...
 * For example, the following code creates a rule for the `electronic` module:
 *
 * ```php
 * new GroupUrlRule([
 *     'prefix' => 'electronic',
 ...
 *
 * [
 *     'electronic/login' => 'electronic/user/login',
 *     'electronic/logout' => 'electronic/user/logout',
 *     'electronic/dashboard' => 'electronic/default/dashboard',
 * ]
 * ```
 *
