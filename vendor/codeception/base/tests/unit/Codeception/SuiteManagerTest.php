...
class SuiteManagerTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testGroupEventsAreFired()
    {
        ...
        $this->dispatcher->addListener('test.before.electronic', $eventListener);
        $this->dispatcher->addListener('test.after', $eventListener);
        $this->dispatcher->addListener('test.after.electronic', $eventListener);
        ...
        $this->assertContains('test.before.electronic', $events);
        $this->assertContains('test.after', $events);
        $this->assertContains('test.after.electronic', $events);
    }
}
