<template>
<div>
    <Button type="primary" @click="turnUrl('/admin/discountEdit/0')">新增</Button>
    <div class="mb"></div>
...
<script>
    export default {
                        ...
                        render: (h, params) => {
                            return h('div', [
                                h('Button', {
                                    ...
                                    on: {
                                        click: ()=>{
                                            this.turnUrl('/admin/discountEdit/'+params.row.id)
                                        }
                                    }
                                }, '编辑'),
                                h('Button', {
        ...
        methods:{
            ...
            refresh(){
                var that=this;
                this.host.post('merchantDiscountList',this.filter).then(function(res){
                    if(res.isSuccess()){
